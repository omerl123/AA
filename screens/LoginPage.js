    ...
    <TouchableWithoutFeedback onPress={() => {
      ...
      <View style={globalStyles.container}>
        ...
        <View style={globalStyles.back}>
          <Text>UserName</Text>
          <TextInput style={globalStyles.input} value={UserName} onChangeText={SetUserName} placeholder='Enter username...' />
          <Text>Password</Text>
          <TextInput style={globalStyles.input} value={Password} onChangeText={SetPassword} placeholder='Enter password...' />
          <View style={globalStyles.buttonContainer}>
            <Button title='Login' style={globalStyles.button} onPress={() => navigation.navigate("Scan")}></Button>
